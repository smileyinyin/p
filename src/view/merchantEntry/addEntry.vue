                  ...
                  <Row class="mt20">
                    <i-col span="12">
                      <FormItem label="商户名称：" prop="merchantsId">
                          <Select v-model="posApply.apply.merchantsId" @on-change="getMarketList" filterable>
                      ...
                      <FormItem label="门店名称：" prop="merchantsStoresId">
                          <Select v-model="posApply.apply.merchantsStoresId" @on-change="getImg" label-in-value ref="marketSelect" filterable>
...
export default {
  ...
  created() {
    ...
    // 获取商户列表
    getMerchantsList({ status: 3, type: this.type, currentPage: 1, pageSize: 10000 }).then(res => {
  ...
  methods: {
    ...
    getMarketList(val) {
      ...
      this._clearInfo()
      // 根据商户id获取门店列表
      getStoresList({ merchantId: pid, currentPage: 1, pageSize: 10000 }).then(res => {
      ...
      getIndustryAndLegal(pid).then(res => {
        ...
        this._setLegalInfo(this.imgInfo)
