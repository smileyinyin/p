<template>
  <div class="entry">
    ...
    <Modal v-model="isShow" title="加机操作" scrollable>
      <div slot="footer">
    ...
    <Modal v-model="isShowPosStatus" :mask-closable="false" :closable="true" title="审核列表" width="800" class-name="flex-vertical-center" scrollable>
        <div slot="footer">
    ...
    <Modal v-model="isShowActive" :mask-closable="false" :closable="true" title="激活操作" class-name="vertical-center-modal" scrollable>
        <div slot="footer">
    ...
    <Modal v-model="isShows" :mask-closable="false" :closable="true" title="换机操作" class-name="vertical-center-modal" scrollable>
        <div slot="footer">
