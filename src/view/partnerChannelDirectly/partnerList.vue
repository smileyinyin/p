      ...
      <Row :gutter="10" class="mb20">
        <i-col :span="24" style="display:flex">
          ...
          <Row type="flex" justify="end" style="flex:1">
            ...
            <DatePicker class="w140 mr20" v-model="createTime" type="datetimerange" placement="bottom-end" placeholder="选择日期"></DatePicker>
          ...
          render: (h, params) => {
            ...
            return h('div', [
              h('Button', {
                ...
                on: { click: () => this.$router.push({ name: 'channelPartnerCheck', query: { id: params.row.id } }) }
              }, '查看'),
              act && h('Button', {
  ...
  methods: {
    ...
    getPartnerList() {
      let query = Object.assign({}, this.searchForm, this.pager, {
        create_time: formatDate(this.createTime[0], 'yyyy-MM-dd hh:mm:ss'),
        end_time: formatDate(this.createTime[1], 'yyyy-MM-dd hh:mm:ss')
      })
